  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Bin Type Display */}
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">This Week's Bin: {thisWeekCollectionDay}</h2>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Next Collection Day: {nextWeekCollectionDay}</h2>
          <div className={`${nextBinColorClass} p-6 rounded-lg text-center`}>
            <p className="text-3xl font-semibold">{nextBinLabel}</p>
          </div>
        </div>
